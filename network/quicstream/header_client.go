...
func NewHeaderClientBroker(
	...
	return &HeaderClientBroker{encs: encs, enc: enc, r: r, w: w}
}
...
func (h HeaderClientBroker) WriteRequestHead(header RequestHeader) error {
	...
	return HeaderWriteRequestHead(h.w, header.Handler(), h.enc, header)
}

func (h HeaderClientBroker) WriteHead(header Header) error {
	return HeaderWriteHead(h.w, h.enc, header)
}
...
func (h HeaderClientBroker) ReadHead() (enc encoder.Encoder, header Header, _ error) {
	return HeaderReadHead(h.r, h.encs)
}
...
func HeaderWriteRequestHead(w io.Writer, prefix string, enc encoder.Encoder, header Header) error {
