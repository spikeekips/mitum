...
type NetworkClient interface {
	...
	LastSuffrageProof(_ context.Context, connInfo quictransport.ConnInfo, manifest util.Hash) (_ base.SuffrageProof, found bool, _ error)
	SuffrageProof(_ context.Context, connInfo quictransport.ConnInfo, state util.Hash) (_ base.SuffrageProof, found bool, _ error)
